"""
Command-line interface for utility scripts.

This module provides the main CLI entry point for the utility scripts package,
...
from utility_scripts.common.logging import setup_logging
from utility_scripts.common.exceptions import UtilityScriptError


def main() -> int:
    """
    Main entry point for the utility-scripts CLI.
    ...
    parser = argparse.ArgumentParser(
        prog="utility-scripts",
        description="Utility scripts for system administrators and DevOps engineers.",
    )
    ...
    try:
        ...
        if args.command == "http500":
            ...
            from utility_scripts.http.http500 import main as http500_main
            return http500_main() or 0
            
        elif args.command == "readonly":
            # Import and call the readonly module's main function
            from utility_scripts.filesystem.readonly import main as readonly_main
            ...
            from utility_scripts.dns.manager import main as dns_main
