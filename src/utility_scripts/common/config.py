"""
Configuration management for utility scripts.

This module provides consistent configuration management across
all utility scripts, supporting environment variables, config files,
...
class ConfigManager:
    """Central configuration management for utility scripts.
