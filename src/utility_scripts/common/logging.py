"""
Logging utilities for the utility scripts collection.

This module provides consistent logging configuration across all
utility scripts, with support for various log destinations and formats.
"""
...
def setup_logging(
    ...
    """Configure logging for utility scripts.
